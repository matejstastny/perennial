...
void WorldGenerator::_bind_methods() {
	ClassDB::bind_static_method("WorldGenerator", D_METHOD("generate", "width", "height", "seed"), &WorldGenerator::generate);
}
